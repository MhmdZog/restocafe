            ...
            <div class="container">
                <div class="row">
					...
					<strong></strong></address>
                            <p>
                                <i class="icon-phone"></i>+961-70905671<br>
                                <i class="icon-envelope-alt"></i>mohamad.alzoghbi
                                @hotmail.com
                            </p>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="copyright">
                                <p>
                                    <span>&copy; 2018 All right reserved.  By </span><a href="" target="_blank">Mohamad Al-Zoghbi</a>
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-6">
